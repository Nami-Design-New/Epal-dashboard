    ...
    (
      ...
      sessionStorage.getItem("defaultAttribute") !== JSON.stringify(a)
        ...
        : (
            ...
            (e["data-sidebar-size"] = sessionStorage.getItem(
              "data-sidebar-size"
            )),
            (e["data-bs-theme"] = sessionStorage.getItem("data-bs-theme")),
            (e["data-layout-width"] = sessionStorage.getItem(
              "data-layout-width"
            )),
            (e["data-sidebar"] = sessionStorage.getItem("data-sidebar")),
            (e["data-sidebar-image"] = sessionStorage.getItem(
              "data-sidebar-image"
            )),
            ...
            (e["data-layout-style"] = sessionStorage.getItem(
              "data-layout-style"
            )),
